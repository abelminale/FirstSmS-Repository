                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    <thead>
										...
										<?php 
										$INSERTquery="SELECT `id`, `Project_No`, `RFQ`, `Quotation_Status`, `Contract_Status`, `Contract_Signed_Date`, `Manufacturing`, `Delivery_Due_Date`, `Contract_Amount`, `Collected_Amount`, `Document` FROM `sales_record`";
...
echo "<td>" . "<a href='EditProjectAction.php?id=" . $row['id'] . "" . "'><button type='submit' name='edit' value=" . $row['id'] . "" . ">Edit</button></a></td>";
echo "</tr>";
}
										?>
