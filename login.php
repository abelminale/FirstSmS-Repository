...
<?php 
    ...
    if(isset($_POST['submit'])){
		...
		$type=$row['Type'];
		        if(mysqli_num_rows($login_res)>0 && $type=="sales" ){
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Login</h3>  </br> <h3 style="color: red;"><?php if (!empty($_POST))echo $error_message;?></h3></div>
                                    <div class="card-body">
