                    ...
                    <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i>
                                 <a href="EditProject.php" ><button type="button" name="add_data" id="add_data" class="btn btn-success btn-xs">Edit Project </button></a>
      </div>
                            ...
                            <div class="card-body">
                                <table id="data_table"  class="table table-striped">
                                    <thead>
										...
										<?php 
			$INSERTquery="SELECT  `id`, `Item_Name`, `Project_ID`, `UoM`, `Qty`, `Item_Description` FROM `item` where Project_ID='$id'";
...
echo "</tr>";
    ...
    columns: {
        identifier: [0, 'id'],
        editable: [[1, 'Project_No'], [2, 'Item_Name'], [3, 'UoM',], [4, 'Qty'], [5, 'Item_Description']]
